...
bb:
  call void @llvm.dbg.value(metadata i32 %arg, i64 0, metadata !12, metadata !13), !dbg !14
...
bb3:                                              ; preds = %bb
  call void @llvm.dbg.value(metadata i32 %arg, i64 0, metadata !15, metadata !13), !dbg !16
  br label %bb8, !dbg !20

bb5:                                              ; preds = %bb
  %tmp7 = sub nsw i32 0, %arg, !dbg !21
  call void @llvm.dbg.value(metadata i32 %tmp7, i64 0, metadata !15, metadata !13), !dbg !16
  br label %bb8
...
!20 = !MDLocation(line: 6, column: 3, scope: !18)
!21 = !MDLocation(line: 8, column: 7, scope: !18)
!22 = !MDLocation(line: 10, column: 2, scope: !4)
