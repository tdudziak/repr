...
bb:
  ...
  call void @llvm.dbg.declare(metadata !{i32* %tmp}, metadata !12), !dbg !13
...
bb3:                                              ; preds = %bb
  %tmp4 = load i32* %tmp, align 4, !dbg !19
  store i32 %tmp4, i32* %y, align 4, !dbg !19
  br label %bb8, !dbg !19

bb5:                                              ; preds = %bb
  %tmp6 = load i32* %tmp, align 4, !dbg !20
  %tmp7 = sub nsw i32 0, %tmp6, !dbg !20
  store i32 %tmp7, i32* %y, align 4, !dbg !20
  br label %bb8

bb8:                                              ; preds = %bb5, %bb3
  %tmp9 = load i32* %y, align 4, !dbg !21
  ret i32 %tmp9, !dbg !21
}
...
!14 = metadata !{i32 786688, metadata !4, metadata !"y", metadata !5, i32 3, metadata !8, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [y] [line 3]
!15 = metadata !{i32 3, i32 6, metadata !4, null}
!16 = metadata !{i32 3, i32 2, metadata !4, null}
